...
exports.run = function(client, message, args) {
  ...
  .setColor("GREEN")
  .setDescription(`<a:tik:807285568966230066> <@${sahip}> adlı kişinin <@${botisim}> adlı botu onaylandı.\n Onaylayan yetkili : ${message.author}`)
  ...
  message.channel.send(`<a:tik:807285568966230066> Botu onayladınız.`).then(msg => msg.delete(1000))
