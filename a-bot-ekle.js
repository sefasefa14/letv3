...
exports.run = function(client, message, args) {
  ...
  .setColor("PURPLE")
  .setDescription(`<a:zil:807286166319136784> ${message.author} adlı kullanıcının <@${botid}> adlı botu sıraya ekledi. Botu onaylanmayı bekliyor. `)
  ...
  message.channel.send(` <a:zil:807286166319136784> Bot ekleme isteğiniz alındı.`).then(msg => msg.delete(1000))
  }
};
////fiber botlist & code
exports.conf = {
